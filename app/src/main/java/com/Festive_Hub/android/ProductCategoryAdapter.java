...
public class ProductCategoryAdapter extends RecyclerView.Adapter<ProductCategoryAdapter.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.productDiscountPrice.setText("₹" + arrayList.get(position).getProductDiscountPrice());
        holder.productPrice.setText( "₹" + arrayList.get(position).getProductPrice());
        holder.productDiscount.setText(arrayList.get(position).getDiscount()+"% off");
